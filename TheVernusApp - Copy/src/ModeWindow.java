 ...
 * @author HP
 */
public class ModeWindow extends javax.swing.JFrame {

    /**
     * Creates new form ModeWindow
     */
    public ModeWindow() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("MODE CALCULATIONS");
        ...
        jTextArea1.setFont(new java.awt.Font("Arial Nova Cond", 1, 18)); // NOI18N
    ...
    private void btnstartActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnstartActionPerformed
        ...
        try {
            ...
            jTextArea1.setText(jTextArea1.getText()+"\nThe Mode of the Data Set = "+getMode(Numbers));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ModeWindow.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ModeWindow().setVisible(true);
            }
        });
    }
